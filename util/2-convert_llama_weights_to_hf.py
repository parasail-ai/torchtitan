...
# This is a script to convert the original Llama repo structure to a HF repo
# It is modified from a script
# "transformers/src/transformers/models/llama/convert_llama_weights_to_hf.py"
# in the HF Transformers repo.
# In principle you don't need to change anything here. Just run
# `python 2-convert_llama_weights_to_hf.py`
# The model HF repo will be stored in "to_hf_output"
...
def main():
    ...
    parser.add_argument(
        "--model_size",
        choices=["DRAFT", "7B", "8B", "8Bf", "7Bf", "13B", "13Bf", "30B", "34B", "65B", "70B", "70Bf", "tokenizer_only"],
        default="DRAFT",
